...
export class FoodEvaluationController {
  ...
  public async evaluateFood(
    @TypedBody() request: IFoodEvaluationRequest,
  ...
  public async getWeatherConditions(@TypedBody() location: ILatLng) {
    return await this.foodEvaluationService.getWeatherConditionsForLocation(
      location,
    );
  }
  ...
  public async getEvaluationSummary(
    @TypedBody() request: IFoodEvaluationRequest,
  ): Promise<{ summary: string }> {
    const evaluationResult =
      await this.foodEvaluationService.evaluateFoodByWeather(request);
    const summary =
      this.foodEvaluationService.generateEvaluationSummary(evaluationResult);
